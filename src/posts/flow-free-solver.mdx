...
I kept getting stuck on it. So I built a solver. It started as a class assignment, but also I just genuinely wanted one for when I've been staring at a level for an hour and need a nudge. I know the real fun is solving it myself. One thing led to another and it turned into three different solvers, all running in the browser at **[flow.kongesque.com](https://flow.kongesque.com)**.
